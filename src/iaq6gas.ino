...
#define num_data_points 5 // The MAX number of data points you'll be publishing
#define num_phenom_types 5
...
#define Vc 4.95
#define R0 12.00 // the resistance of the HCHO circuit in ambient conditions
...
String experiment = "Andlinger";  // used for filtering, and to differentiate concurrent experiments in same building
